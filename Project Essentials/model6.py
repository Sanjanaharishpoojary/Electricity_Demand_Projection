...
class DataPreprocessor:
    ...
    def load_and_preprocess_data(self, load_path, weather_path):
        try:
            ...
            load_df = pd.read_csv('D:\Project Essentials\Project Essentials\delhi_load_data_2022-2023_Final.csv')
            weather_df = pd.read_csv('D:\Project Essentials\Project Essentials\delhi_weather_data_2022-2023_Final.csv')
